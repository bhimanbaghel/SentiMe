...
class MaxEntClassifier:
    ...
    def accuracy(self):
        ...
        return 'Total = %d, Correct = %d, Wrong = %d, Accuracy = %.2f' % (total, correct, wrong, self.accuracy)     
    #end
